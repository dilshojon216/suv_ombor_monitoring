...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashPageState);
}
...
/// @nodoc
class $SplashPageStateCopyWith<$Res>  {
$SplashPageStateCopyWith(SplashPageState _, $Res Function(SplashPageState) __);
}


/// Adds pattern-matching-related methods to [SplashPageState].
extension SplashPageStatePatterns on SplashPageState {
...
class _Initial implements SplashPageState {
  const _Initial();
...
class _Loading implements SplashPageState {
  const _Loading();
...
class _Loaded implements SplashPageState {
  const _Loaded();
...
class _Error implements SplashPageState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $SplashPageStateCopyWith<$Res> {
